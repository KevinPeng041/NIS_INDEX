        ...
        <script>
            ...
            function bedcallback(data)
            {
                ...
                if(dataObj){
                    ...
                    document.getElementById("DataTxt").value = dataObj.DataTxt;
                    document.getElementById("DA_idpt").value = dataObj.IDPT;
                    document.getElementById("DA_idinpt").value = dataObj.IDINPT;
                    document.getElementById("DA_sBed").value=dataObj.SBED;
            ...
            btn.onclick=function () {
                ...
                switch (checkBEDwindow()) {
                    case "false":
                        ...
                        break;
                    case "true":
                        x=window.open("/webservice/NISPWSLKCBD.php?str="+AESEnCode("sIdUser=<?php echo $Account?>"),"責任床位",'width=750px,height=650px,scrollbars=yes,resizable=no');
                        break;
                }
               ...
               Serch_btn.onclick=function ()
                {
                   ...
                   switch (checkSerchwindow()) {
                       case "false":
                           ...
                           break;
                       case "true":
                           y=window.open("/webservice/NISPWSLKQRY.php?str="+AESEnCode("PageVal="+$("#PageVal").val()+"&DA_idpt="+$('#DA_idpt').val()+"&DA_idinpt="+$('#DA_idinpt').val()+"&sUser="+$('#sUser').val()+"&NM_PATIENT="+$('#DataTxt').val()),"查詢",'width=750px,height=650px,scrollbars=yes,resizable=no');
                           break;
                   }
                ...
                function delte(num) {
                    ...
                    console.log(del_ip+"?str="+AESEnCode("sFm="+'ILSGA'+"&sTraID="+$('#transKEY').val()+"&sPg="+$("#PageVal").val()+"&sCidFlag=D"+"&sUr="+$("#sUser").val()));
                    $.ajax({
            ...
            function NISPWSFMINI_Timer() {
                ...
                $.ajax({
                    url:"http://localhost/webservice/NISPWSFMINI.php?str="+AESEnCode("sFm=ILSGA&sPg=A"),
                    type:"POST",
                    dataType:"text",
                    success:function(data){
                        var json=JSON.parse(AESDeCode(data));
