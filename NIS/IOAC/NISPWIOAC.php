...
<script>
    $(document).ready(function () {
        ...
        $(document).on('change','input[type=radio]',function () {
            ...
            DB_WSST("C",$("#sTraID").val(),JSON.stringify(Save_Obj),'','','','','','false');
        });
        $(document).on('click','button',function () {
            ...
            switch (Btn_ID) {
                case "SubmitBtn":
                    ...
                    DB_WSST("C",TransKEY,JSON.stringify(Save_Obj),$("#sDate").val(),'','','','<?php echo $sUr?>','true');
                ...
                case "SearchBtn":
                    if (checkSerchwindow()===true)
                    {
                        ...
                        AESEnCode("sFm=IOAC&PageVal=" + "" + "&DA_idpt=" + IdPt + "&DA_idinpt=" + InPt
        ...
        function DB_DEL(Page,sTraID,sUr) {
            $.ajax("/webservice/NISPWSDELILSG.php?str="+AESEnCode("sFm="+'IOAC'+"&sTraID="+sTraID+"&sPg="+Page+"&sCidFlag=D"+"&sUr="+sUr))
                .done(function (data) {
        ...
        function GetINIJson(IdPt,InIdPt,sUr){
            $.ajax("/webservice/NISPWSTRAINI.php?str="+AESEnCode('sFm=IOAC&idPt='+IdPt+'&INPt='+InIdPt+"&sUr="+sUr))
                .done(function(data) {
        ...
        function GetPREJson(Page,sTraID) {
            $.ajax("/webservice/NISPWSGETPRE.php?str="+AESEnCode("sFm=IOAC&sTraID="+sTraID+"&sPg="+Page))
                .done(function (data) {
                    let obj=JSON.parse(AESDeCode(data));
                    console.log(obj);
